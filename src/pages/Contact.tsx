          ...
          <div className="space-y-8">
            {contactEmails.map(({ label, email, description }) => (
              ...
              >
                ...
                <a
                  href={`mailto:${email}`}
                  className="inline-flex items-center gap-3 px-6 py-3 border border-foreground/30 text-foreground text-xs font-display tracking-[0.15em] uppercase hover:bg-foreground hover:text-background transition-all duration-300 whitespace-nowrap"
                >
