          ...
          <div className="space-y-8">
            {contactEmails.map(({ label, email, description }) => (
              ...
              >
                ...
                <a
                  href={`mailto:${email}`}
                  className="inline-flex items-center gap-3 px-4 py-3 border border-foreground/30 text-foreground text-[10px] sm:text-xs font-display tracking-[0.1em] sm:tracking-[0.15em] uppercase hover:bg-foreground hover:text-background transition-all duration-300 w-full md:w-auto justify-center md:justify-start"
                >
