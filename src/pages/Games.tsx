      ...
      <section className="pt-32 pb-16 px-8 md:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-foreground/50 text-sm font-body leading-relaxed max-w-2xl">
            Discover our collection of precision flight simulators and landing challenges. Master the art of rocket recovery and experience the thrill of perfect execution.
          </p>
        </div>
      </section>
