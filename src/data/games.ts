...
export const games: GameData[] = [
  {
    ...
    description:
      "Master the hardcore, Starship-style catch maneuver in Critical Descent. Pilot massive boosters and agile upper stages across 75 handcrafted levels on Earth, the Moon, and Mars. Featuring global leaderboards, multiple difficulties, and a realistic physics system, for the ultimate landing experience.",
    longDescription: [
      ...
      "FLY, FAIL, LEARN\n\n75 handcrafted levels await, each with unique scenarios and increasing difficulty. Execute precise maneuvers, pull off incredible descents, and fail repeatedly, learning after every failure until you finally achieve the perfect landing.",
    ...
    demoReleased: true, // ← Change to true when the demo is live
