...
const DemoSection = () => {
  ...
  // Only show if a demo URL exists
  if (!game?.demoUrl) return null;
  ...
  return (
    <section id="demo" className="section-padding">
      <div className="max-w-6xl mx-auto">
        ...
        <a
          href={isReleased ? game.demoUrl : undefined}
          ...
          onClick={isReleased ? undefined : (e) => e.preventDefault()}
        >
          ...
          {isReleased ? "Download Demo on Steam" : "Demo Coming Soon"}
        </a>
      </div>
    </section>
  );
