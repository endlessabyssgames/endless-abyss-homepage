    ...
    <section id="about" className="py-32 px-8 md:px-12 border-t border-border">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex gap-16 text-foreground/40">
          ...
          {releasedCount > 0 && (
            <div>
              <p className="text-3xl font-display font-bold text-foreground">{releasedCount}</p>
              <p className="text-xs mt-2 tracking-[0.1em] uppercase">Released</p>
            </div>
          )}
          {inDevCount > 0 && (
            <div>
              <p className="text-3xl font-display font-bold text-foreground">{inDevCount}</p>
